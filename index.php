	...
	<div class="middle">
		<div class="inner">
            ...
            <form method="post" style="padding-top:40px">
                ...
                <hr id="two">
                <br><br>
                <input type="submit" class="button" name="login" value="Login" style="width:132.5px">
                <a class="button" name="register" style="margin-right:15px; width:132.5px" href="register.php">Register</a>
            </form>
		<div>
	</div>
</body>
